#use any ID type to get back a mouse-level information
#for the CC-RIX animals. Iif the input type is known, 
#specify input type. this will speed up the translation
#dramatically

get_CC_RIX_mouse_info <- function(input.ID, manifest, input.type = NULL){
