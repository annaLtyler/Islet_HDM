...
pdf(here("Results", "Paper", "fig_panels_densities.pdf"), height = 3, width = 4)
...
in the upper and lower triangles and trait heritabilities
on the diagonal.
...
pheatmap(herit.cor, cluster_cols = trait.clust, cluster_rows = trait.clust)
```