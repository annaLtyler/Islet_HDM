...
pdf(here("Results", "Paper", "fig_panels_densities.pdf"), height = 4, width = 4)
...
pdf(here("Results", "Paper", "Fig_panels_boxes.pdf"), height = 4, width = 4)
par(mar = c(4,8,4,4))
boxplot(glu[not.outlier]~sex[not.outlier], names = c("Female", "Male"), xlab = "",
  ylab = "Fasting Glucose (mg/dL)", col = c(fcol, mcol))
dev.off()

pdf(here("Results", "Paper", "Fig_panels_correlations.pdf"), height = 3, width = 4)
par(mar = c(4,4,1,2))
