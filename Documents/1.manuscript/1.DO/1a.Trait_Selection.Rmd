...
write_table_with_header(pc.mat, file.path(figure.data.dir, "Supp_Fig1A-B.txt"),
  header = "#Data for Supplemental Figures 1B.\n#Contributions of each trait to each eigenvector derived\n#from the singular value decomposition of the trait matrix.\n#PC1 and PC2 were used to generate Supp. Fig. 1B.")
...
write_table_with_header(pc.var, file.path(figure.data.dir, "Supp_Fig1A.txt"),
  header = "#Data for Supplemental Figure 1A.\n#Percent trait variance explained for each principal component.\n#rounded to the nearest whole number.")
...
header <- c("#Data corresponding to Figure 1G. The upper triangle
...
trait.cor.file <- file.path(figure.data.dir, "Fig1G.txt")
write_table_with_header(combo.mat, trait.cor.file, header)
