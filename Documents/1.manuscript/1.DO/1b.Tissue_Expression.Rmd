...
write_table_with_header(pc.table, file.path(figure.data.dir, "Supp_Fig2A.txt"),
  header = "#Data for Supplemental Figure 2A. The first two principal components\n#of the gene expression matrix across all samples.\n#The sex of each animal is indicated as 0 = female and 1 = male.")
```
...
for(tx in 1:length(tissue.data)){
  ...
  file.name = file.path(figure.data.dir, paste0("Supp_Fig2", LETTERS[(tx+1)], ".txt")), 
    header = paste0("#Data for Supplemental Figure 2", LETTERS[(tx+1)], ". eQTL data for ", tissue.names[tx]))
}
...
write_table_with_header(fig.table, file.path(figure.data.dir, "Supp_Fig1H.txt"),
  header = "#Data for Supplemental Figure 1H. Each row identifies which tissues\n#are included in the count. The final column indicates the number of\n#shared distal eQTL across the tissues indicated.")
