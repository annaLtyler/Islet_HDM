...
write_table_with_header(fig.table, file.path(figure.data.dir, "Supp_Fig1F.txt"),
 header = "Data for Supplemental Figure 1F. Counts of local and distal
...
write_table_with_header(fig.table, file.path(figure.data.dir, "Supp_Fig1G.txt"),
  header = "Data for Supplemental Figure 1G. Each row identifies which tissues
...
fig.table <- cbind(combo.mat, combo.counts)
colnames(fig.table)[5] <- "eQTL Count"
write_table_with_header(fig.table, file.path(figure.data.dir, "Supp_Fig1H.txt"),
  header = "Data for Supplemental Figure 1H. Each row identifies which 
