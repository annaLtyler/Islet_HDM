...
for(tx in 1:length(tissue.names)){
    ...
    a <- barplot(extreme.enrich, 
        ...
        xlim = c(-3, 3), name = NA, col = tissue.cols[tx])
...
plot_kegg_picture(search.term = "Oxidative phosphorylation", quote.level = "#####", fig.width = 100)
```
...
plot_kegg_picture("Valine, leucine and isoleucine degradation", quote.level = "#####", fig.width = 75)
#plot_kegg_picture("Citrate cycle (TCA cycle)", quote.level = "#####", fig.width = 75)
```
...
for(tx in 1:length(tissue.names)){
    ...
    a <- barplot(extreme.enrich, 
        horiz = TRUE, las = 2, main = tissue.names[tx], 
        xlim = c(-3, 3), names = NA, col = tissue.cols[tx])
