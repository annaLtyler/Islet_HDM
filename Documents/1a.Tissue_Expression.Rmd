...
#plot decomposition
decomp.file <- here("Results", "Transcriptomes", "Tissue.Decomposition.RDS")
...
local.eqtl.binary.file <- here("Results", "Transcriptomes", "Shared_eQTL_Local_Binary.RDS")
local.eqtl.coef.file <- here("Results", "Transcriptomes", "Shared_eQTL_Local_Coef.RDS")
...
#identify unique local eQTLs that are shared across tissues
distal.eqtl.binary.file <- here("Results", "Transcriptomes", "Shared_eQTL_Distal_Binary.RDS")
distal.eqtl.coef.file <- here("Results", "Transcriptomes", "Shared_eQTL_Distal_Coef.RDS")
...
local.eqtl.cor.file <- here("Results", "Transcriptomes", "Correlation_Allele_Effects_Local.RDS")
...
distal.eqtl.cor.file <- here("Results", "Transcriptomes", "Correlation_Allele_Effects_Distal.RDS")
...
local.expr.cor.file <- here("Results", "Transcriptomes", "Correlation_Expression_Local.RDS")
...
distal.expr.cor.file <- here("Results", "Transcriptomes", "Correlation_Expression_Distal.RDS")
...
int.p.file <- here("Results", "Tissue-Specific_eQTL_p_values.RDS")
tissue.grid.file <- here("Results", "Transcripts_by_Tissue.RDS")
