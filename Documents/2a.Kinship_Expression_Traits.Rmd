...
expr <- readRDS(file.path(data.results.dir, "Tissue_Expression_Adjusted.RDS")) #generated in 1a.Tissue_Expression.Rmd
...
gene.tables <- readRDS(file.path(data.results.dir, "Gene_Tables.RDS")) #generated in 1a.Tissue_Expression.Rmd

pheno <- readRDS(file.path(data.results.dir, "Clinical_Phenotypes_Adjusted.RDS")) #generated in 1b.Trait_Selection.Rmd
