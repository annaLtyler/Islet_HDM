...
jeff.genes <- c("Pnpla2", "Mogat2", "Hadha", "Cpt2", "Capn3", "Ccl2", "Prkaa1", "Prkaa2")
...
tissue.loadings <- readRDS(here("Results", "DO", "High_Dim_Med_no_MGE", exp.name, "Loadings_Transcripts_0.RDS"))
```
